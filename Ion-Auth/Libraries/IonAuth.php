...
class IonAuth
{
        ...
        if ($user)
        {
            ...
            if ($code)
            {
                ...
                else
                {
                   ...
                   $this->email->attach('http://pol.cm-mealhada.pt/assets/img/logo.png', 'inline');
                    //$this->email->attach('http://pol.cm-mealhada.pt/assets/img/naminharua_banner.png', 'inline');
        ...
        array $data): bool
    {
        ...
        $this->email->attach('https://tombola.cm-mealhada.pt/images/logo.png', 'inline');
