...
class IonAuth extends \CodeIgniter\Config\BaseConfig
{
	 ...
	 */
	public $siteTitle                = 'Tômbola Digital';       // Site Title, example.com
	public $adminEmail               = 'admin@camara.pt'; // Admin Email, admin@example.com
	public $defaultGroup             = 'clientes';           // Default group, use name
	...
	public $userExpire               = 3600;               // How long to remember the user (seconds). Set to zero for no expiration
