...
return [
	...
	'forgot_password_successful'         => 'Foi enviado um email para que possa redefinir a senha',
	...
	'emailActivate_heading'    			=> 'Ativação da conta para o utilizador %s',
	'emailActivate_subheading' 			=> 'Por favor, clique neste link para %s.',
	'emailActivate_link'       			=> 'ativar a sua conta',

	// Forgot Password Email
	'email_forgotten_password_subject'   => 'Esqueci a senha',
	'emailForgotPassword_heading'    	=> 'Redefinindo a senha para %s',
	'emailForgotPassword_subheading' 	=> 'Por favor, clique neste link para %s.',
	'emailForgotPassword_link'       	=> 'redefinir sua senha',
];
