                            ...
                            <?php foreach($fields as $field) { ?>
                                <div class="form-group <?php echo $field->field_name; ?>_form_group">
                                    <label class="col-sm-3 control-label">
                                      ...
                                      <?php if (isset($input_fields[$field->field_name]->db_comment) && $input_fields[$field->field_name]->db_comment!=""){?>
                            <img src="<?php echo base_url('images/info_icon.png')?>" data-toggle="tooltip" title=" <?php echo $input_fields[$field->field_name]->db_comment?>">
                            <?php }?>
                                    </label>
                                    <div class="col-sm-9">
