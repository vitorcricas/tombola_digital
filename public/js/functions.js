                ...
                $ajaxForm.each(function() {
                    ...
                    elem.submit(function(event) {
                        ...
                        if (elem[0].checkValidity() === false) {
                            ...
                            button.html('<i class="icon-loader fa-spin"> </i> A enviar...');
                            $.ajax({
                                url: post_url,
                                type: request_method,
            ...
            if ($countdownTimer.length > 0) {
                ...
                $(".countdown").each(function(index, element) {
                    ...
                    elem.countdown(finalDate, function(event) {
                        elem.html(
                            event.strftime(
                                '<div class="countdown-container"><div class="countdown-box"><div class="number">%-D</div><span>Dias</span></div>' +
                                ...
                                '<div class="countdown-box"><div class="number">%S</div><span>Segundos</span></div></div>'
                            )
                        );
                    });
                });
