            ...
            <div class="row">
                ...
                <div class="sidebar sticky-sidebar col-lg-4">
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-6 col-xs-12">
                            <button type="button" class="btn-reveal btn-reveal-left btn btn-default btn-small text-light"><i class="fas fa-hand-point-right"></i>&nbsp;<a href="<?php echo base_url('/adesao'); ?>"> Quero ser aderente</a></button>
                        </div>
                        <div class="col-lg-6 col-xs-12">
                    ...
                    <div class="card  text-left">
                        ...
                        <h4 class="card-header">Atividade</h4>
                        <div class="card-body">
                            <div class="col-lg-12">
                ...
                <div class="col-lg-8" id="page_list">
                    ...
                    foreach ($comerciantes as $comerciante) : ?>
                        ...
                        <div class="card text-left merchant_info" data-nome="<?= $comerciante["nome"] ?>" data-freg="<?= $comerciante["freguesia"] ?>" data-disp="<?= $disponibilidade ?>" data-atividade="<?= $comerciante["atividade"] ?>">
                            ...
                            <div class="card-body">
                                <div class="row">
                                    ...
                                    <div class="col-lg-8">
                                        <p><span class="card-title">Área: </span><span><?= $comerciante["atividade"] ?></span><br>
                                            <span class="card-title">Morada: </span><span><?= $comerciante["morada"] ?></span><br>
                                            <span class="card-title">Contacto: </span><span><?= $comerciante["contato"] ?></span><br>
                                            <span class="card-title">Email: </span><span><?= $comerciante["email"] ?></span>
                                        </p>
                                    </div>
                                </div>
                            </div>
...
<script>
    ...
    $(document).ready(function() { //          
        ...
        $(document).on("click", "#searchMerchants", function() {
            toggleMerchants();
    ...
    function toggleMerchants() {
        ...
        $(".merchant_info").each(function(index) {
            if (freguesias.includes($(this).data("freg")) && atividades.includes($(this).data("atividade")) && $(this).data("nome").toLowerCase().includes($("#pesquisar").val().toLowerCase())) {
                ncomer++;
                $(this).fadeIn("slow");
            } else
                $(this).fadeOut("slow");
    ...
    <?php foreach ($comerciantes as $comerciante) : ?>
        ...
        if ($lat !== "") :
            ...
            $label .= '<div class="row">' .
                ...
                '</div>' .
                '<div class="col-lg-8"><p><span class="card-title">Área: </span><span>' . $comerciante["atividade"] . '</span><br>' .
                '<span class="">Freguesia: </span><span>' . $comerciante["freguesia"] . '</span><br>' .
                '<span class="card-title">Morada: </span><span>' . $comerciante["morada"] . '</span><br>' .
                '<span class="card-title">Contacto: </span><span>' . $comerciante["contato"] . '</span><br>' .
                '<span class="card-title">Email: </span><span>' . $comerciante["email"] . '</span></p></div></div>';

        ?>
            ponto = {
                atividade: '<?= $comerciante["atividade"] ?>',
