...
<link type="text/css" rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/pivottable/2.23.0/pivot.min.css" />
...
<div class="container-fluid" style="overflow:auto">
    ...
    <div style="padding: 10px">
    <a class="btn btn-default" href="<?php echo base_url("admin/stats"); ?>">Vouchers</a>
...
<script type="text/javascript">
    ...
    $(document).ready(function() {
        ...
        $(function() {
            ...
            jQuery.ajax({
                type: "POST",
                url: "<?php echo base_url("admin/getEstatisticasQuiz"); ?>",
